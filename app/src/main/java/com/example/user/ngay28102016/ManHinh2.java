...
public class ManHinh2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttback = (Button)findViewById(R.id.buttonback);
        ...
        Toast.makeText(ManHinh2.this, String.valueOf(result[0]),Toast.LENGTH_LONG).show();
        ...
        bttsentdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ManHinh2.this,String.valueOf(res1),Toast.LENGTH_LONG).show();
        ...
        bttback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent point = new Intent(ManHinh2.this,PointMapView.class);
                Bundle bundle = new Bundle();
                bundle.putDouble("toado_x",result[0]);
                bundle.putDouble("toado_y",result[1]);
                point.putExtra("toado",bundle);
                startActivity(point);
            }
        });
    ...
    class UpdateThingspeakTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            try {
                ...
                Toast.makeText(ManHinh2.this,"fail",Toast.LENGTH_LONG).show();
                return null;
            }
        }

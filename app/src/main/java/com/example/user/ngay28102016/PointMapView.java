...
public class PointMapView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_map_view);
        l = 25;
        w = 50;
        ...
        Toast.makeText(PointMapView.this,"Tọa đô x ="+ String.valueOf(x)+"Tọa đô y ="+ String.valueOf(y),Toast.LENGTH_LONG).show();
        ...
        relativeLayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                imgView.setImageResource(R.drawable.point);

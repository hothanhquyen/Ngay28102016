...
import com.example.user.ngay28102016.Model.SQLiteHelper;
...
public class MainActivity extends AppCompatActivity {
    public ArrayList<WiFi> myWifi = new ArrayList<WiFi>();
    ...
    * */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // add mywifi1
        WiFi myWiFi1 = new WiFi("CafeNhaGo", 17.8, 11.6, 3.5 );
        myWifi.add(myWiFi1);
        // add mywifi2
        WiFi myWiFi2 = new WiFi("REWA_NVQ",0.2,11.6,3.5);
        myWifi.add(myWiFi2);
        // add mywifi3
        WiFi myWiFi3 = new WiFi();
        myWiFi3.setSSID("CafeNhaGo_Lau1");
        myWiFi3.x = 16.2;
        myWiFi3.y = 0.2;
        myWiFi3.z = 3.5;
        myWifi.add(myWiFi3);
        ...
        sqLiteHelper.storeDatabase(myWifi);
